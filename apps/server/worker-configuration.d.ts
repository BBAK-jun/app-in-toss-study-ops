...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "TOSS_AUTH_MODE" | "TOSS_API_BASE_URL" | "ALLOWED_ORIGINS" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
